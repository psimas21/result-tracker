    ...
    <Layout>
        <main class="flex-1">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                <h1 class="text-2xl font-semibold text-gray-900">Post Report</h1>
            </div>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
               <Modal
                    title="Title"
                    ...
                    <template #footer>
                        ...
                        <Button type="success" size="small">Post</Button>
                    </template>
                </Modal>
                ...
                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                    <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 sm:w-auto" @click="resModal = true">
